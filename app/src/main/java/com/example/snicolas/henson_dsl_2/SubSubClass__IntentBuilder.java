...
public class SubSubClass__IntentBuilder {
    ...
    public SubSubClass__IntentBuilder(Context context) {
        ...
        final SuperClass__IntentBuilder.RequiredSequence rs2 = new SuperClass__IntentBuilder.RequiredSequence<>(bundle, allSet);
        final SubClass__IntentBuilder.RequiredSequence rs1 = new SubClass__IntentBuilder.RequiredSequence<>(bundle, rs2);
